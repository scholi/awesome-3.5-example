...
theme_path = os.getenv("HOME") .. "/.config/awesome/themes/scholi"
...
theme.awesome_icon = theme_path .. "/icons/archlinux.png"

theme.blingbling = {
    background_color= "#00000000",
    graph_background_color = widget_background,
    graph_color = bright_magenta,
    reboot = theme_path .. "/icons/reboot.png",
    shutdown = theme_path .. "/icons/shutdown.png"
}
...
theme.tasks_icon      = theme_path .. "/icons/task.png"
theme.task_done_icon  = theme_path .. "/icons/task2.png"
theme.widget_cpu      = theme_path .. "/icons2/cpu.png"
theme.widget_mem      = theme_path .. "/icons2/mem.png"
theme.widget_netup    = theme_path .. "/icons2/up.png"
theme.widget_netdown  = theme_path .. "/icons2/down.png"
theme.time_icon       = theme_path .. "/icons2/time.png"
theme.widget_hdd      = theme_path .. "/icons2/disk.png"
theme.widget_vol      = theme_path .. "/icons2/vol.png"
theme.musicpause_icon = theme_path .. "/icons/toggleplay.png"
theme.musicnext_icon  = theme_path .. "/icons/next.png"

theme.vol_off   = theme_path .. "/icons2/vol-off.png"
theme.vol0      = theme_path .. "/icons2/vol0.png"
theme.vol1      = theme_path .. "/icons2/vol1.png"
